...
var BOOKS = [
    ...
    new Book(2, 'ＮＨＫラジオ 入門ビジネス英語「ネイティブが教える-コミュニケーションテクニック６０」', 'https://www.amazon.co.jp/ＮＨＫ-ＣＤ-ＢＯＯＫ-ＮＨＫラジオ-入門ビジネス英語-ネイティブが教える-コミュニケーションテクニック６０-エド・' +
        'スミス/dp/4140395427/ref=sr_1_1?ie=UTF8&qid=1498846085&sr=8-1&keywords=ＮＨＫラジオ-入門ビジネス英語-ネイティブが教える-コミュニケーションテクニック６０-', './assets/book2-bg.png', 2),
...
var TabsComponent = (function () {
    ...
    TabsComponent.prototype.selectTab = function (tab) {
        this.tabs.forEach(function (mytab) {
            mytab.active = false;
        });
        tab.active = true;
    };
